	...
	<body>
		<div class="main-block">
			...
			{{ csrf_field() }}
				...
				@endif
				<div class="info">
					<input class="fname" type="text" name="name" placeholder="Nama Produk">
					...
					<input type="text" name="stock" placeholder="Jumlah stock">
					<select name="po_status" id="po_">
						<option value="null">Pre order?</option>
						<option value="po">Ya</option>
						<option value="null">Tidak</option>
					</select>
					<input type="text" name="po_duration" placeholder="Durasi PO">
				</div>
